...
{
	public float speed = 15.0f, lifeTime = 1.5f, damageAmount = 5, forceAmount = 5, radius = 1.0f, seekPrecision = 1.3f;
	...
	private void Update()
	{
		if (Time.time > spawnTime + lifeTime) Spawner.Destroy(gameObject);

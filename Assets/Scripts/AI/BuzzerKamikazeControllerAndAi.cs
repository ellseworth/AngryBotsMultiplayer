...
public class BuzzerKamikazeControllerAndAi : MonoBehaviour
{
	...
	private CachedComponent<AudioSource> audioSource;
	...
	private void Awake()
	{
		...
		audioSource = new CachedComponent<AudioSource>(gameObject);
	}
	...
	private IEnumerator DoElectricArc()
	{
		if (electricArc.enabled) yield break;
		// Play attack sound

		audioSource.Value.clip = zapSound;
